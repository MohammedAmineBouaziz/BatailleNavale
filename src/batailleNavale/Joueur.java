...
//-------------1.3 Explications pour les méthodes abstraites.
	...
	//	Cette méthode est invoquée sur le joueur defenseur à la fin d’un tour de jeu. c est la
	...
	//	Cette méthode est invoquée sur le joueur défenseur après le choix de l’attaquant, c est la
	//	coordonnée à laquelle l’attaquant a choisi d’effectuer un tir. Elle retourne le résultat du tir
	//	qui ne peut être que TOUCHE, COULE, A_L_EAU, ou GAMEOVER.
